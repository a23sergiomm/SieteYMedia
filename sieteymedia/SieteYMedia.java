...
public class SieteYMedia{
    ...
    public void jugar() {
        turnoJugador();
        turnoBanca();
        System.out.println("Adios " + nombreJugador + "!!!");
    }
    ...
    public void turnoJugador() {
        ...
        while (valorCartas(cartasJugador) < 7.5 && opc == 'C') {
            ...
            System.out.println("Éstas son tus cartas "+nombreJugador+":");
    ...
    public void turnoBanca() {
        ...
        if (valorCartasJugador > 7.5) {
            System.out.println(nombreJugador+" , te has pasado en tu jugada anterior, gana la banca");
            return;
        }
        System.out.println("\n\nTurno de banca ...");
        ...
        if (valorCartas(cartasBanca) > 7.5) {
            System.out.println("Me pasé, ganas tú, "+nombreJugador);
        } else {
    ...
    public static void main(String[] args) {
        ...
        juego.presentarJuego();
        juego.turnoJugador();
        juego.turnoBanca();
        System.out.println("Se acabo el juego. Adios!!!");
    }
}
